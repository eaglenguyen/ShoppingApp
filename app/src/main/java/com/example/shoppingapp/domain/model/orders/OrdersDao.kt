...
interface OrdersDao {
    ...
    // must return type Long if you want retrieve the autogenerated ID
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insertCartItemsToDetail(detailItem: OrderDetailEntity): Long // The return type Long tells Room: “Return the new row ID after insert.”
